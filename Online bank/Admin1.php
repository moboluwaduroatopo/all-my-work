	...
	Class admin{
      ...
      public $connect;
		 ...
		 function connect(){
			...
			$result=mysqli_query($this->connect, "INSERT INTO admin_td(Firstname,lastname,email,address,phone,password) VALUES ('$firstname','$lastname','$email','$address','$phone','$password')");
				if ($result) {
