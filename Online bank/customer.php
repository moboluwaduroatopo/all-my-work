...
<body>
   ...
   <div class="container"   id="margin">
   	...
   	<form id="" class="form-horizontal" method="post" action="customerconnect.php" enctype="multipart/form-data">

<fieldset>

<!-- Form Name -->
<legend style="color:#FF5500; text-align: center;">CUSTOMER REGISTRATION FORM</legend>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="lastnmae" name="lastname" type="text" placeholder="lastname" class="form-control input-md" required="">
...
<div class="form-group">
 ...
 <p>
    Already a customer?  <a href="customerlogin.php" class="">login </a>
    </p>
</fieldset>
</form>
   </div>
