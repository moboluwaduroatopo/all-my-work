...
<body>
   <div class="container" id="margin">
   	<form class="form-horizontal" method="post" action="customerlogincon.php" enctype="multipart/form-data">

<fieldset>

<!-- Form Name -->
<legend style="color:#FF5500">CUSTOMER LOGIN FORM</legend>
...
<div class="form-group">
 ...
 <p>
    Not a Customer?  <a href="customer.html" class="">Register </a>
    </p>
</fieldset>
</form>
   </div>
