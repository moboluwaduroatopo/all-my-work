		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
							...
							<ul class="slides">
								<li data-thumb="<?php echo $prodimage; ?>">
									<div class="thumb-image">
										<img src="<?php echo $prodimage; ?>" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="<?php echo $prodimage; ?>">
									<div class="thumb-image">
										<img src="<?php echo $prodimage; ?>" data-imagezoom="true" class="img-fluid" alt=""> </div>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3 product"><?php echo $prodname; ?></h3>
					<!-- <p class="mb-3 pric">
						<span class="item_price price"><?php //echo $prodprice; ?></span>
					...
					<!-- <div class="occasion-cart">
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							...
							<input type="submit" name="submit" value="Add to cart" class="button add-to-cart "  id="add-to-cart"/>
							<p class="info hidethis" style="color:red;"><strong>Product Added to Cart!</strong></p>
						</div>
					</div> -->
				</div>
