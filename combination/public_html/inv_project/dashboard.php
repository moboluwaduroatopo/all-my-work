		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
						...
						<a  data-toggle="modal" data-target="#form_category" class="btn btn-primary">Add</a>
			...
			<div class="col-md-4">
				<div class="card">
						...
						<a  data-toggle="modal" data-target="#form_brand" class="btn btn-primary">Add</a>
			...
			<div class="col-md-4">
				<div class="card">
						...
						<a  data-toggle="modal" data-target="#form_products" class="btn btn-primary">Add</a>
