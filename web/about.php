		...
		<div class="container">
			<div class="col-md-6">
				<div class=" address-grid">
							...
							<div class="address1">
								<h3>Address</h3>
								<p>kobaope area, beside abomota grammer school</p>
							</div>
						...
						<div class=" address-grid ">
							...
							<div class="address1">
							<h3>Email:</h3>
								<p><a href="mailto:info@example.com">moboluwaduro0112@gmail.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class=" address-grid ">
			...
			<div class="col-md-6">
				<h3 class="text-center">contract us</h3>
				<p>You may be to find your reply on support</p>
