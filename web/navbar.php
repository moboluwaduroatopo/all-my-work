<?php  $con=mysqli_connect("localhost","root","","ad10cakstore"); ?>
<?php session_start(); ?>
    ...
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
    		...
    		<li class="dropdown mega-dropdown active">
			    <a class="color1" href="#" class="dropdown-toggle" data-toggle="dropdown">Birthday Cakes
             ...
             $con=mysqli_connect("localhost","root","","ad10cakstore");
					...
					?>
					<div class="col1 col5">
						<img src="images/birthday cakes.jpg" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>                  
				</div>				
			...
			<li class="dropdown mega-dropdown active">
			    <a class="color1" href="#" class="dropdown-toggle" data-toggle="dropdown">Celebration Cakes
			    	<span class="caret"></span></a>				
				<div class="dropdown-menu ">
                    <div class="menu-top">	
                    	<?php
             ...
             $con=mysqli_connect("localhost","root","","ad10cakstore");
					...
					?>
					<div class="col1 col5">
						<img src="images/celebration cakes.jpg" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>                  
				</div>				
			...
			<li class="dropdown mega-dropdown active">
			    <a class="color2" href="#" class="dropdown-toggle" data-toggle="dropdown">Cup cakes<span class="caret"></span></a>				
